        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-body bg-model">
                ...
                <div class="contect">
                    <div class="container">
                      <form  action="{{ route('teacher.update') }}" class="submit-form" method="POST" enctype="multipart/form-data">
                        @csrf
                      <div class="row align-items-center mt-3">
                        <div class="col-2">
                          ...
                          <div class="edit-profile-image text-right">
                            <img class="rounded-circle" src="{{ $user->image_url }}" height="108" width="108" alt="" title="">
                        ...
                        <div class="row w-75 mx-auto">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control dark-input" id="name" type="text" autocomplete="off" placeholder="إسم المستخدم" name="name" value="{{ $user->name }}">
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                  ...
                                  <input class="form-control dark-input" id="email" type="email" name="email" autocomplete="off" placeholder="nn0114250@gmail.com" value="{{ $user->email }}">
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                  ...
                                  <input class="form-control dark-input" id="job" type="text" name="job" autocomplete="off" placeholder="مساعد مدرس" value="{{ $user->teacher->job }}">
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                  ...
                                  <textarea class="form-control dark-input" id="bio" type="text" name="bio">{{ $user->teacher->bio }}</textarea>
